...
//        greeting(); // you cant use this because it requires an instance but the function you are using it in does not depend on instances
    ...
    void fun2() {
        // every non-static will eventually be bound to a static method (main in this case)
        //so no need to create an object for greeting() as inside main funn object is created for fun2
        // and greeting() is eventually bind to this funn object
        greeting();
    }

    // we know that something which is not static, belongs to an object
    void greeting() {
        fun(); //assessing static method inside non static is possible
