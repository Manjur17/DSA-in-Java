...
public class LastOccurrenceBinarySearch {
    ...
    public static void main(String[] args) {
        ...
        int x =s.nextInt();
        System.out.println("The element is present last at index using recursion: " + binarySearch(input,x));
        System.out.println("The element is present last at index using iteration: " + binarySearchBetter(input,x));
    }
}
